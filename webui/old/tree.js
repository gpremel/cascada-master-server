...
Tree.prototype.buildTree = function (nodes, depth) {
  ...
  if (nodes && nodes.length) {
    nodes.forEach(function (node) {
      var liEle = Tree.createLiEle(node, depth === _this2.options.closeDepth - 1, depth);
...
Tree.createLiEle = function (node, closed, depth=-1) {
  var li = document.createElement('li');
  li.classList.add('treejs-node');
  
  if(depth != -1 && depth > 0) li.classList.add('treejs-subnode');
